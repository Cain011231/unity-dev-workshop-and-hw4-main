...
namespace Oculus.Interaction.HandPosing
{
    public class DataCollection : MonoBehaviour
    {
        ...
        */
        ...
        [SerializeField] private GameObject targetCube;  // Reference to grabable cube
        ...
        void Update()
        {
            ...
            if (isEnd){                
                ...
                float targetPos = targetCube.transform.position.x;
                grabDistance = Mathf.Abs(targetPos - initialPos);

                if (grabDistance >= 0.2 * grabSize) {
                    Debug.Log("Failed attempt, less than 80% overlap");
                    WriteToFile(-1, -1, -1);
                } else {
                ...
                // Reset grabbable cube to initial position
                cube.transform.position = new Vector3(-0.3f, -0.15f, 0.4f);
            }   
